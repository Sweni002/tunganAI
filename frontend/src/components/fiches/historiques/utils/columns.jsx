...
/**
 * Colonnes "Agents de bureau" (matin / après-midi détaillés + statut).
 */
 ...
 */
export function buildColumnsSurface() {
  return [
    { title: 'Matricule', dataIndex: 'matricule', key: 'matricule' },
    {
      title: <span style={{ fontWeight: 'bold' }}>Nom</span>,
      key: 'nom_prenom',
      align: 'center',
      render: (record) => (
    ...
    },
    {
      ...
      align: 'center',
      render: (_, record) =>
        !record.absence_unique && record.heure_entree_unique ? (
          <Tooltip title="Présent">
            <CheckCircleIcon style={{ color: 'green', fontSize: '1.1rem' }} />
          </Tooltip>
        ) : (
